...
class LFM:
    ...
    def Train(self,X_train,y_train, alpha = 0.0001,lambda_u = 0.25,lambda_i = 0.25,train_times = 100):
        ...
        print("训练前的总评分误差： {sum0}".format(sum0))  #3.06
    ...
    def lfm_test(self,X_test,y_test):  
        ...
        print("在测试集上的总分误差：{sum1}s".format(sum1))  #573188(10),51992(20),46243(40),36958(100)
        RSE = self.Get_RSE(Rate,X_test,y_test)
        print("测试集上的回归误差：{RSE}".format(RSE))#2.29(10)，2.13(20),1.93(40),1.57(100)
